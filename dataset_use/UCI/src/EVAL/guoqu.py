...
from dataset_use.UCI.src.EVAL.reduced_params import ReducedParams, BALANCED, PRIVACY_FIRST, UTILITY_FIRST
# ================= 默认 sweep 组合 ================= #
...
def main():
    ...
    # NYC 数据集路径
    ap.add_argument('--reports_csv', default='/Users/wanghao/Desktop/SA-HTD/dataset_use/SPBC/data/reports.csv')
    ap.add_argument('--truth_csv',   default='/Users/wanghao/Desktop/SA-HTD/dataset_use/SPBC/data/truth.csv')
    ap.add_argument('--outdir',      default='/Users/wanghao/Desktop/SA-HTD/dataset_use/SPBC/result')

    ap.add_argument('--n_workers', type=int, default=300)
    ap.add_argument('--seed', type=int, default=2025)
    ap.add_argument('--time_bin', default='600min')
