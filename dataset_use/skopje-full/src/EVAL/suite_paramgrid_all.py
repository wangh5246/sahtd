...
def main():
    ...
    # NYC 数据集路径
    ap.add_argument('--reports_csv', default='/Users/wanghao/Desktop/SA-HTD/dataset_use/skopje-full/data/reports.csv')
    ap.add_argument('--truth_csv',   default='/Users/wanghao/Desktop/SA-HTD/dataset_use/skopje-full/data/truth.csv')
    ap.add_argument('--outdir',      default='/Users/wanghao/Desktop/SA-HTD/dataset_use/skopje-full/result')
    ap.add_argument('--n_workers', type=int, default=300)
    ap.add_argument('--seed', type=int, default=2025)
    ap.add_argument('--time_bin', default='60min')
    ...
    # 后处理（Kalman + 图拉普拉斯）相关
    ap.add_argument('--post_lap_alpha', type=float, default=0.0,
